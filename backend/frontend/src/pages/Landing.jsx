  ...
  return (
    <div ref={pageRef} className="relative isolate overflow-x-clip bg-[var(--lp-bg)] font-['Inter',sans-serif] text-[var(--lp-ink)]">
      ...
      <header className="relative z-10 mx-auto flex h-24 max-w-[1400px] items-center justify-between gap-6 border-b border-[var(--lp-line)] px-6 pr-20 sm:px-10 sm:pr-24 lg:px-16 lg:pr-28">
        ...
        <nav aria-label="Main navigation" className="hidden items-center gap-8 text-sm text-[var(--lp-muted)] md:flex">
          ...
          <a className="transition-colors hover:text-[var(--lp-ink)]" href="#questions">Questions</a>
        </nav>
      ...
      <main id="main-content" className="relative z-0">
        <section data-hero className="relative mx-auto grid max-w-[1400px] grid-cols-1 items-start gap-12 px-6 pt-12 pb-16 sm:gap-16 sm:px-10 sm:pt-16 lg:px-16 lg:pt-20 lg:pb-20">
          <div className="relative z-10 mx-auto w-full max-w-[800px] text-center">
            ...
            <div data-hero-copy className="mt-9 flex flex-wrap items-center justify-center gap-3">
              ...
              <button type="button" aria-disabled="true" title="Walkthrough coming soon" className="inline-flex min-h-14 cursor-default items-center gap-2.5 rounded-full border border-[var(--lp-line)] px-5 text-sm text-[var(--lp-ink)]"><Icon name="play" className="size-4" />Watch walkthrough<span className="ml-1 text-xs text-[var(--lp-muted)]">Soon</span></button>
            </div>
        ...
        <section id="questions" className="mx-auto grid max-w-[1400px] scroll-mt-8 gap-10 px-6 py-24 sm:px-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-24 lg:px-16 lg:py-28">
